...
__export(index_exports, {
  ...
  EnclosureStorage: () => EnclosureStorage,
  Storage: () => Storage,
...
var Storage = class {
  constructor(configDir) {
    this.configDir = configDir || (0, import_node_path.join)((0, import_node_os.homedir)(), ".string-skill");
...
var EnclosureStorage = class {
  constructor(configDir) {
    this.configDir = configDir || (0, import_node_path2.join)((0, import_node_os2.homedir)(), ".string-skill");
